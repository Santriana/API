def score_course(mid_score, overall_mid_weight, final_score, overall_final_weight, CO_mid_weight, CO_final_weight, quiz_score, overall_quiz_weight, CO_quiz_weight, contribution):
    ...
    for i in range(10):
        try:
            score += (mid_score*overall_mid_weight/100*CO_mid_weight[i]/100+final_score*overall_final_weight/100*CO_final_weight[i]/100+quiz_score*overall_quiz_weight/100*CO_quiz_weight[1]/100)/(contribution[i]/5)
